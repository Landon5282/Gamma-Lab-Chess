<template>
  <div class="home">
    ...
    <el-row class="chess" display="margin-top:10px">
      <el-input v-model="inputname" placeholder="请输入玩家姓名" style="display: inline-table; width: 18%; float: left; margin-right:8px"></el-input>
      <!--<el-button @click="addPlayer()" style="margin: 2px; float:left; background: bisque">确认</el-button>-->
      <el-input v-model="inputsize" placeholder="请输入棋盘大小" style="display: inline-table; width: 18%; float: left; margin-left:8px"></el-input>
    ...
    <el-row display="margin-bottom: 1rem">
      ...
      <select name="" id="" v-model="selectID" @click="getID()" style="background: bisque; float: left; height: 40px; border-radius: 6px; margin-top:10px ">
